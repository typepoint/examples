...
import React, {
  memo, useCallback, useState, ChangeEvent, useRef,
} from 'react';
...
export const TodoList = memo(({
  onDeleteTodo, onSetTodoTitle, onToggleAll, onToggleTodo, todos,
}: TodoListProps) => (
...
const TodoListItem = memo(({
  todo, onSetTodoTitle, onDeleteTodo, onToggleTodo,
}: TodoListItemProps) => {
  ...
  const deleteTodo = useCallback(() => onDeleteTodo(todo.id), [onDeleteTodo, todo.id]);

  const toggleTodo = useCallback((event: ChangeEvent<HTMLInputElement>) => {
